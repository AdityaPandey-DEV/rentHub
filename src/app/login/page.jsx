      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[var(--bg-primary)] opacity-80 flex items-center justify-center p-12">
          <div className="text-center text-[var(--text-primary)] max-w-md">
            ...
            <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 italic">RENTHUB</h2>
            <p className="text-[var(--text-secondary)] font-bold uppercase tracking-widest text-xs leading-relaxed">
              ACCESS YOUR PROFESSIONAL DASHBOARD TO MANAGE RENTALS AND PAYMENTS.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12" style={{ background: 'var(--bg-primary)' }}>
        <div className="w-full max-w-md animate-fadeInUp">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-black uppercase tracking-tighter mb-2" style={{ color: 'var(--text-primary)' }}>Sign In</h1>
            <p className="text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>Enter your credentials to access your account</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required
                  placeholder="YOU@EXAMPLE.COM" className="input pl-12 h-14 border-2 !rounded-none" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required
                  placeholder="••••••••" className="input pl-12 h-14 border-2 !rounded-none" />
              </div>
            </div>

            <button type="submit" disabled={loading} className="btn btn-primary w-full h-14 font-black uppercase tracking-widest">
          ...
          <p className="mt-8 text-center text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link href="/register" className="text-[var(--text-primary)] underline">Sign Up</Link>
          </p>
